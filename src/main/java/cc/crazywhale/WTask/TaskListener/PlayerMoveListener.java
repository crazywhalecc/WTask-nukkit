...
public class PlayerMoveListener extends TaskListenerBase implements Listener, TaskListener {
    ...
    public PlayerMoveListener(WTaskAPI api, ArrayList<Map<String, String>> task, String tn){
        this.api = api;
    ...
    public void runActTask(PlayerMoveEvent event, int ID){
